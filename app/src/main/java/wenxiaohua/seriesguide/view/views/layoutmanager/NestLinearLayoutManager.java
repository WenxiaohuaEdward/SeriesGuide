...
import wenxiaohua.seriesguide.BuildConfig;

/**
 * Created by hexun on 2016/6/29.
 */
public class NestLinearLayoutManager extends android.support.v7.widget.LinearLayoutManager {
        ...
        @SuppressWarnings("UnusedDeclaration")
        public NestLinearLayoutManager(RecyclerView view) {
        ...
        @SuppressWarnings("UnusedDeclaration")
        public NestLinearLayoutManager(RecyclerView view, int orientation, boolean reverseLayout) {
